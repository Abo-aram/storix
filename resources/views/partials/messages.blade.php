...
@if (session('message'))
    <div 
        ...
        x-show="show" 
        x-transition 
        class="fixed bottom-6 right-6 max-w-sm w-full bg-gradient-to-r from-blue-600 to-blue-500 text-white p-4 pl-6 pr-10 rounded-xl shadow-xl flex items-center space-x-4 z-50"
    >
